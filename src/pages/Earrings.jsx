    ...
    function Earrings(){
      return (
       ...
       <div className='flex justify-between items-center p-4'>
        <img className='w-[50%] h-[600px] ' src="https://media.tiffany.com/is/image/tiffanydm/2025_HW_2x2_TILE1?$tile$&wid=1488&hei=1488&defaultImage=NoImageAvailableInternal&fmt=webp" alt="right" />
        <img className='w-[50%] h-[600px] ' src="https://media.tiffany.com/is/image/tiffanydm/2024_ICONS_BC_2x2_ONFIG2?$tile$&wid=1488&hei=1488&defaultImage=NoImageAvailableInternal&fmt=webp" alt="left" />
       </div>
